...
class ManagingApp:
    ...
    def register_user(self, first_name: str, last_name: str, driving_license_number: str):
        try:
            existing_user = [user for user in self.users if user.driving_license_number == driving_license_number][0]
    ...
    def upload_vehicle(self, vehicle_type: str, brand: str, model: str, license_plate_number: str):
        ...
        try:
            existing_vehicle = [v for v in self.vehicles if v.license_plate_number == license_plate_number][0]
    ...
    def allow_route(self, start_point: str, end_point: str, length: float):
        try:
            greater_route = [r for r in self.routes if r.start_point == start_point and r.end_point == end_point and r.length > length][0]
