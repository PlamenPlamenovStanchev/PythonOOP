from PythonOOP.unit_testing.CarManager.car_manager import Car
...
class TestCar(TestCase):
    ...
    def test_car_set_fuel_consumption_equal_or_less_then_zero_raises(self):
        with self.assertRaises(Exception) as ex:
    ...
    def test_car_set_fuel_amount_equal_or_less_then_zero_raises(self):
        with self.assertRaises(Exception) as ex:
    ...
    def test_refuel_with_less_than_fuel_capacity(self):
        self.assertEqual(0, self.car.fuel_amount)
        self.car.refuel(10)
